"""Sensor platform for napco_ibridge."""
...
from .air_quality import ENTITY_DESCRIPTIONS as AIR_QUALITY_DESCRIPTIONS, NapcoIbridgeAirQualitySensor
from .diagnostic import ENTITY_DESCRIPTIONS as DIAGNOSTIC_DESCRIPTIONS, NapcoIbridgeDiagnosticSensor
