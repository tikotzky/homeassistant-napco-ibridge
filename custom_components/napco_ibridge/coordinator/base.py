"""
Core DataUpdateCoordinator implementation for napco_ibridge.
...
from custom_components.napco_ibridge.api import (
    NapcoIbridgeApiClientAuthenticationError,
    NapcoIbridgeApiClientError,
)
from custom_components.napco_ibridge.const import LOGGER
...
class NapcoIbridgeDataUpdateCoordinator(DataUpdateCoordinator):
    """
    ...
    async def _async_update_data(self) -> Any:
        ...
        except NapcoIbridgeApiClientAuthenticationError as exception:
            LOGGER.warning("Authentication error - %s", exception)
            raise ConfigEntryAuthFailed(
                translation_domain="napco_ibridge",
                translation_key="authentication_failed",
            ) from exception
        except NapcoIbridgeApiClientError as exception:
