...
from custom_components.napco_ibridge.config_flow_handler.schemas import (
    get_reauth_schema,
    get_reconfigure_schema,
    get_user_schema,
)
from custom_components.napco_ibridge.config_flow_handler.validators import validate_credentials
...
if TYPE_CHECKING:
    from custom_components.napco_ibridge.config_flow_handler.options_flow import NapcoIbridgeOptionsFlow

# Map exception types to error keys for user-facing messages
ERROR_MAP = {
    "NapcoIbridgeApiClientAuthenticationError": "auth",
    "NapcoIbridgeApiClientCommunicationError": "connection",
}


class NapcoIbridgeConfigFlowHandler(config_entries.ConfigFlow, domain=DOMAIN):
    """
    Handle a config flow for napco_ibridge.
    ...
    def async_get_options_flow(
        ...
        """
        from custom_components.napco_ibridge.config_flow_handler.options_flow import (  # noqa: PLC0415
            NapcoIbridgeOptionsFlow,
        )
