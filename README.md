...
[![Open in GitHub Codespaces](https://github.com/codespaces/badge.svg)](https://codespaces.new/mordytk/homeassistant-napco-ibridge?quickstart=1)
...
[![Open your Home Assistant instance and open a repository inside the Home Assistant Community Store.](https://my.home-assistant.io/badges/hacs_repository.svg)](https://my.home-assistant.io/redirect/hacs_repository/?owner=jpawlowski&repository=homeassistant-napco-ibridge&category=integration)
...
1. Download the `custom_components/napco_ibridge/` folder from this repository
...
[![Open your Home Assistant instance and start setting up a new integration.](https://my.home-assistant.io/badges/config_flow_start.svg)](https://my.home-assistant.io/redirect/config_flow_start/?domain=napco_ibridge)
...
Find all entities in **Settings** → **Devices & Services** → **Napco iBridge** → click on the device.
...
```yaml
service: napco_ibridge.example_action
data:
  # Add your parameters here
```

### `napco_ibridge.reload_data`
...
```yaml
service: napco_ibridge.reload_data
```
...
4. Check the integration diagnostics (Settings → Devices & Services → Napco iBridge → 3 dots → Download diagnostics)
...
**Made with ❤️ by [@mordytk][user_profile]**

---

[commits-shield]: https://img.shields.io/github/commit-activity/y/mordytk/homeassistant-napco-ibridge.svg?style=for-the-badge
[commits]: https://github.com/mordytk/homeassistant-napco-ibridge/commits/main
...
[releases-shield]: https://img.shields.io/github/release/mordytk/homeassistant-napco-ibridge.svg?style=for-the-badge
[releases]: https://github.com/mordytk/homeassistant-napco-ibridge/releases
