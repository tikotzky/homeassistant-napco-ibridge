# Getting Started with Napco iBridge

This guide will help you install and set up the Napco iBridge custom integration for Home Assistant.
...
5. Add this repository URL: `https://github.com/mordytk/homeassistant-napco-ibridge`
6. Set category to "Integration"
7. Click "Add"
8. Find "Napco iBridge" in the integration list
9. Click "Download"
10. Restart Home Assistant

### Manual Installation

1. Download the latest release from the [releases page](https://github.com/mordytk/homeassistant-napco-ibridge/releases)
2. Extract the `napco_ibridge` folder from the archive
3. Copy it to `custom_components/napco_ibridge/` in your Home Assistant configuration directory
...
4. Select entities from "Napco iBridge"
...
- Report issues at [GitHub Issues](https://github.com/mordytk/homeassistant-napco-ibridge/issues)

## Support

For help and discussion:

- [GitHub Discussions](https://github.com/mordytk/homeassistant-napco-ibridge/discussions)
