...
- Inherit from `NapcoIbridgeEntity` and platform base class
...
- Entity: `custom_components/napco_ibridge/[platform]/[entity_name].py`
- Platform: `custom_components/napco_ibridge/[platform]/__init__.py`
