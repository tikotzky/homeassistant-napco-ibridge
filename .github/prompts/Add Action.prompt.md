...
**File:** `custom_components/napco_ibridge/services.yaml`
...
Create `custom_components/napco_ibridge/service_actions/[action_name].py`:

```python
"""[Action name] service action for Napco iBridge."""
...
**File:** `custom_components/napco_ibridge/__init__.py`
...
**File:** `custom_components/napco_ibridge/const.py`
...
3. Find service action: `napco_ibridge.[action_name]`
...
- **Service actions directory:** `custom_components/napco_ibridge/service_actions/` (preferred) or `actions/`
- **Service actions definition:** `custom_components/napco_ibridge/services.yaml` (legacy filename)
- **Icons:** `custom_components/napco_ibridge/icons.json` under `services` key (legacy)
- **Translations:** `custom_components/napco_ibridge/translations/*.json` under `services` key (legacy)
