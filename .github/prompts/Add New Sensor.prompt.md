...
- Create new sensor file in `custom_components/napco_ibridge/sensor/`
- Inherit from `NapcoIbridgeEntity` and `SensorEntity`
...
```python
"""[Sensor description] for Napco iBridge."""
...
class NapcoIbridge[SensorName]Sensor(
    NapcoIbridgeEntity,
    SensorEntity,
):
...
- Entity: `custom_components/napco_ibridge/sensor/[sensor_name].py`
- Platform: `custom_components/napco_ibridge/sensor/__init__.py`
- Translations: `custom_components/napco_ibridge/translations/*.json`
