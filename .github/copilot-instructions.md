...
- **Main code:** `custom_components/napco_ibridge/`
...
- `entity/` — Base entity class (`NapcoIbridgeEntity`)
...
- Entity MRO: `(PlatformEntity, NapcoIbridgeEntity)` — order matters
...
- Debug level: `custom_components.napco_ibridge: debug` in `config/configuration.yaml`
